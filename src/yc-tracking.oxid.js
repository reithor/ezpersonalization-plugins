function initYcTrackingModule(context) {
    ...
    function hookBasketHandlers() {
        var forms = document.querySelectorAll(YC_BASKET_FORMS_SELECTOR),
            ...
            onClickLink = function (e) {
                ...
                YcTracking.trackBasket(1, tempId, document.location.pathname, language);
            },
    ...
    function fetchRecommendations() {
        ...
        url = url.replace('http:', location.protocol) + 'Yoochoose/';
        for (i = 0; i < allBoxes.length; i++) {
            ...
            if (tpl.enabled) {
                ...
                window[fncName] = fetchRecommendedProducts(allBoxes[i], url);
